window.LISBON_DATA = {
  ...
  chapters: [
    ...
    { dayId: 'sat', title: 'Alfama + Castle + Taberna', subtitle: 'Alfama climb, Castelo de São Jorge, Chiado shops, early Taberna name-down', stamp: 'Old-town glow' },
  ...
  days: [
    ...
    },
    {
      ...
      day: 'Saturday',
      date: 'June 27',
      title: 'Alfama Climb, Castle & Taberna',
      mood: 'Alfama climb, castle views, souvenir loop, and Taberna night before the Sintra push.',
      ...
      timeline: [
        ...
        ['11:45am', 'Continue uphill to Castelo de São Jorge and arrive a little before the target entry window.'],
        ['12:00-12:20pm', 'Keep Castelo de São Jorge tight: quick ramparts, city views, and out in time for lunch.'],
        ['12:30pm', 'Confirmed reservation at O VINHAÇA: Tapas & Vinhos. This is the Saturday lunch anchor.'],
        ['2:00pm', 'Drift back down through Alfama lanes toward Baixa or Chiado after lunch.'],
      ...
      optional: ['Add Senhora do Monte only if skies are clear and the group still has energy after Alfama.', 'Hold a backup dinner option at Ofício or Prado if you want insurance against the Taberna wait.', 'If the castle timing gets tight, protect O VINHAÇA and make the castle a viewpoint-only pass.', 'If the group wants one more view without the climb, use a Bolt instead of forcing extra hills.'],
      watch: ['Do not waste time in the Tram 28 or Santa Justa Lift lines.', 'Protect the 12:30pm O VINHAÇA reservation; keep Castelo short.', 'Do not over-walk before Sunday; Senhora do Monte is optional, not mandatory.', 'Taberna is a walk-up bet, so put the name down early and set a hard pivot time.', 'Avoid Bairro Alto chaos after dinner; this should be an early, clean night.'],
      variants: { low: 'Skip Senhora do Monte and do only Sé, Santa Luzia, Portas do Sol, O VINHAÇA, Chiado shops, Manteigaria, and early dinner.', rain: 'Make it a Baixa/Chiado indoor day with O VINHAÇA, Bertrand, A Vida Portuguesa, Manteigaria, and Taberna; taxi to one viewpoint only if the rain breaks.' },
      links: [
    ...
    },
    {
      ...
      timeline: [
        ['Early morning', 'Train to Sintra. Build the morning around the 10:00am Pena Palace booking.'],
        ['10:00am', 'Pena Palace timed booking. This is now the first fixed Sintra anchor.'],
        ['12:30-1:30pm', 'Quinta da Regaleira timed booking. Keep the transfer from Pena realistic.'],
        ['Afternoon', 'Sintra snack/lunch and decompression. Do not add Monserrate unless the day is somehow running beautifully.'],
        ['Late afternoon', 'Transfer toward Cascais / Guincho. Consider Bolt/Uber/private transfer for this awkward middle leg.'],
        ['Before dinner', 'Cascais or Guincho coast time only as energy allows.'],
        ['8:00pm', 'Furnas do Guincho reservation. Make this the Atlantic seafood finale.'],
        ['After dinner', 'Taxi/Bolt/Uber or train route back to Lisbon. No major nightlife required.']
      ],
      optional: ['Monserrate only if timing, weather, and energy are all unusually good.', 'Fallback: Pena + Regaleira + dinner, with less Cascais wandering.'],
      watch: ['Do not add Cabo da Roca unless the group explicitly wants a long scenic detour.', 'Do not attempt Pena + Regaleira + Monserrate + Cascais + Guincho as if transit is frictionless.'],
      variants: { low: 'Pena, Regaleira, slow transfer, Furnas do Guincho. Cut extra sightseeing.', rain: 'Keep the timed bookings if tolerable; otherwise decide morning-of and protect the dinner reservation.' },
      links: [
        ...
        ['Furnas do Guincho', 'https://www.furnasdoguincho.pt/']
      ]
    },
    {
      id: 'mon',
  ...
  restaurants: [
    ...
    { id: 'canalha', rank: 2, name: 'Canalha', role: 'Monday Belém lunch anchor', verdict: 'Add / Confirmed', tags: 'top group modern seafood belem lunch confirmed', why: 'Chef-driven modern Portuguese in Belém — the main Monday meal before the sunset cruise.', booking: 'Confirmed Monday lunch at 12:45pm; pair with Belém before Doca de Alcântara.', siteUrl: 'https://www.canalha.pt/homepage/', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Canalha%20Lisbon%20Portugal' },
    { id: 'o-vinhaca', rank: 3, name: 'O VINHAÇA: Tapas & Vinhos', role: 'Confirmed Saturday lunch', verdict: 'Add / Confirmed', tags: 'group lunch confirmed tapas wine saturday', why: 'Confirmed Saturday 12:30pm lunch, replacing the loose Alfama lunch block.', booking: 'Confirmed Saturday Jun 27 at 12:30pm.', siteUrl: '', mapUrl: 'https://www.google.com/maps/search/?api=1&query=O%20Vinhaca%20Tapas%20%26%20Vinhos%20Lisbon%20Portugal' },
    ...
    { id: 'taberna-rua-flores', rank: 6, name: 'Taberna da Rua das Flores', role: 'Confirmed Saturday dinner strategy', verdict: 'Add / Confirmed', tags: 'top romantic group traditional wine confirmed', why: 'Tiny old Lisbon room, sharing plates, wine, loud/fun energy, no pretension.', booking: 'Confirmed plan: go early, put the name down, then drink at a nearby bar while waiting.', siteUrl: 'https://taberneiros.pt/', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Taberna%20da%20Rua%20das%20Flores%20Lisbon%20Portugal' },
    ...
    { id: 'furnas-guincho', rank: 28, name: 'Furnas do Guincho', role: 'Confirmed Sunday 8:00pm dinner', verdict: 'Add / Confirmed', tags: 'cascais seafood romantic splurge confirmed', why: 'Dramatic Atlantic seafood setting and now the booked dinner anchor after Sintra.', booking: 'Confirmed for Sunday at 8:00pm. Plan the Sintra to Guincho transfer deliberately.', siteUrl: 'https://www.furnasdoguincho.pt/', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Furnas%20do%20Guincho%20Cascais%20Portugal' },
  ...
  activities: [
    ...
    { id: 'castelo-sao-jorge', name: 'Castelo de São Jorge', verdict: 'Add', why: 'Plugs into the Saturday Alfama climb right after Portas do Sol; ramparts, peacocks, and the best panoramic view of central Lisbon.', price: 'Timed entry — book official', time: '~2 hours', siteUrl: 'https://castelodesaojorge.pt/en/', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Castelo+de+S%C3%A3o+Jorge+Lisbon' },
    ...
    { id: 'senhora-monte', name: 'Senhora do Monte', verdict: 'Optional / Skip', why: 'Redundant after Santa Luzia, Portas do Sol, the castle ramparts, and the Monday Tagus sunset cruise — Visit Lisboa frames it as a calm panoramic viewpoint, which is exactly why it works better as a 20-minute Bolt detour than a scheduled stop. Do not force it before Taberna and the early Sintra wake-up.', price: 'Free', time: '20-30 minutes', siteUrl: '', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Miradouro%20da%20Senhora%20do%20Monte%20Lisbon' },
  ...
  routes: [
    ...
    { id: 'alfama-gold', title: 'Saturday Alfama Viewpoints', stops: ['Rua da Madalena', 'Sé Cathedral', 'Santa Luzia', 'Portas do Sol', 'Castelo de São Jorge', 'Alfama lanes'], note: 'Do this slowly on Saturday. No Tram 28 line required.' },
  ...
  bookingTimeline: [
    ...
    ['Confirmed', 'Saturday O VINHAÇA lunch', 'high', ['O VINHAÇA: Tapas & Vinhos is confirmed for Saturday Jun 27 at 12:30pm.', 'Keep Castelo de São Jorge short so lunch is protected.']],
    ['Now / ASAP', 'Castelo de São Jorge entry', 'high', ['Book the official 12:00pm Saturday Jun 27 slot via castelodesaojorge.pt only if you still want a tight castle pass before lunch.', 'Skip resellers and combo tickets — plain castle entry only.', 'Arrive by 11:45am after Portas do Sol.']],
    ['Confirmed', 'Monday Canalha lunch', 'high', ['Canalha is confirmed for 12:45pm Monday as the main Belém meal.', 'Do not rely on O Vinhaca — wrong geography for the cruise day.']],
