window.TRIP_DATA = {
  "days": [
    {
      ...
      "day": "Sunday",
      "date": "July 5",
      "title": "Arrival + Bloomsbury Pub Night",
      "mood": "Ease in, old pub glass, soft landing.",
      "hero": "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=1800&q=80",
      "score": {
        "Romance": 7,
        "London": 9,
        "Stress": 2,
      ...
      "timeline": [
        [
          "Afternoon",
          "Arrive from Dublin via Heathrow. Piccadilly Line to Russell Square unless exhausted or delayed."
        ],
        [
          "Check-in",
          "Kimpton Fitzroy London — your elegant Bloomsbury anchor."
        ],
        [
          "Early evening",
          "Walk Lamb’s Conduit Street and stop at The Lamb for a classic pub start."
        ],
        [
          "Dinner",
          "The Harrison for easy pub comfort, or Noble Rot if you want a more food-forward first night."
        ]
      ],
      "watch": [
        "Do not over-plan Sunday. Travel days are where beautiful itineraries go to die.",
        "If delayed, skip anything that requires punctuality and just do a nearby pub."
      ],
      "links": [
        [
          "Kimpton Fitzroy",
        ...
        [
          "Walk: Kimpton → The Lamb",
          "https://www.google.com/maps/dir/?api=1&origin=Kimpton%20Fitzroy%20London&destination=The%20Lamb%20Bloomsbury&travelmode=walking"
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "links": [
        [
          "Wimbledon Queue",
          "https://www.wimbledon.com/en_GB/tickets/the_queue"
        ],
        [
          "Wimbledon schedule",
    ...
    },
    {
      ...
      "timeline": [],
      "watch": [
        "This is the day to protect from overstuffing.",
        "If you choose Studio Tour, give it room. Do not pretend it is a quick morning errand."
      ],
      "links": [
        [
          "The Mousetrap",
        ...
        [
          "Borough → Covent Garden walk",
          "https://www.google.com/maps/dir/?api=1&origin=Borough%20Market&destination=Covent%20Garden%20London&waypoints=Southwark%20Cathedral%7CMillennium%20Bridge%7CSt%20Paul%27s%20Cathedral&travelmode=walking"
        ]
      ]
    },
    {
      ...
      "timeline": [
        [
          "Morning",
          "Coffee/breakfast near Bloomsbury if time allows."
        ],
        [
          "Airport",
          "Piccadilly Line if timing is safe; taxi/Elizabeth Line if comfort and margin matter more."
        ]
      ],
      "watch": [
        "Do not get cute with the airport morning. Leave enough margin."
      ],
      "links": [
        [
          "TfL journey planner",
  ...
  "paths": {
    "A": {
      ...
      "timeline": [
        [
          "8:00am",
          "Leave Kimpton Fitzroy for Warner Bros. Studio Tour transport."
        ],
        [
          "9:30am–1:30pm",
          "Studio Tour. Give yourselves time for sets, props, butterbeer, shop, photos."
        ],
        [
          "~3:00pm",
          "Back in central London. Rest, change, maybe a gentle drink."
        ],
        [
          "7:30pm",
          "Clos Maggiore. Ask for conservatory seating; make this the romantic finale."
        ],
        [
          "After",
          "Optional slow walk through Covent Garden / Seven Dials."
        ]
      ],
      "why": "This treats HP as the main daytime event and avoids making your last night feel like a military operation.",
      "trade": "You lose a lot of central London wandering time."
    },
    "B": {
      "name": "Path B · London purist",
      "badge": "Borough walk + Soane’s + Mousetrap + Clos Maggiore",
      "best": "If you want the day to feel like London, not logistics.",
      "verdict": "Recommended.",
      "hero": "https://images.unsplash.com/photo-1529655683826-aba9b3e77383?auto=format&fit=crop&w=1800&q=80",
      "scores": {
        "Romance": 10,
      ...
      "timeline": [
        [
          "10:00am",
          "Borough Market. Coffee, grazing, no formal lunch needed."
        ],
        [
          "11:15am",
          "Southwark Cathedral → Millennium Bridge → St Paul’s. This is the cinematic London walk."
        ],
        [
          "1:30pm",
          "Sir John Soane’s Museum or Covent Garden / bookshop wandering."
        ],
        [
          "4:00pm",
          "Optional pause at Ye Olde Mitre, The Lamb, or hotel reset."
        ],
        [
          "7:30pm",
        ...
        [
          "9:45pm",
          "Clos Maggiore late dinner. Romantic, theatrical, last-night energy."
        ]
      ],
      "why": "This is the version most likely to feel like a love letter to London: markets, river, architecture, mystery play, romantic dinner.",
      "trade": "Dinner is late. That is the cost of pairing theater with Clos Maggiore."
    },
    "C": {
      "name": "Path C · Ambitious compromise",
      ...
      "timeline": [
        [
          "7:45am",
          "Leave for Studio Tour. You need the earliest realistic entry."
        ],
        [
          "9:00am–1:00pm",
          "Studio Tour, but with a firmer exit time than ideal."
        ],
        [
          "~3:00pm",
          "Back in central London. Reset quickly."
        ],
        [
          "6:00pm sharp",
          "Clos Maggiore early seating. Tell them you have theater."
        ],
        [
          "7:30pm",
          "The Mousetrap."
        ...
        [
          "After",
          "Drinks only, if still alive."
        ]
      ],
      "why": "It technically lets you touch all the major ideas.",
      "trade": "It risks making the whole day feel rushed and less romantic."
    }
  },
  "restaurants": [
    [
      "The Harrison",
      "Arrival-night pub",
      "28 Harrison St, King’s Cross",
      "Keep for Sunday. Not the meal of the trip; exactly right after travel.",
    ...
    [
      "Trullo",
      "Foodie friend dinner",
      "300–302 St Paul’s Rd, Highbury",
      "Best if your friend values food first.",
    ...
    [
      "The Tamil Prince",
      "Fun friend dinner",
      "115 Hemingford Rd, Islington",
      "Best if the point is a lively night out with your friend.",
    ...
    [
      ...
      "Keep if you can get conservatory seating.",
    ...
    [
      ...
      "Great backup / first-night upgrade / wine bar option.",
  ...
  "experiences": [
    [
      "Regent’s Canal Walk",
      "Walk",
      "Sunday if energized, Wednesday if Path B, or a bonus gap",
      "King’s Cross → Coal Drops Yard → Camden → Primrose Hill gives you cinematic, local-feeling London near your friend geography.",
      "https://www.google.com/maps/dir/?api=1&origin=Coal%20Drops%20Yard&destination=Primrose%20Hill&waypoints=Camden%20Market&travelmode=walking"
    ],
    [
      "Borough → St Paul’s → Covent Garden",
      "Walk",
      "Wednesday Path B",
      "The strongest central London walk in the plan: food, river, cathedral views, Fleet Street/Temple texture, West End finish.",
      "https://www.google.com/maps/dir/?api=1&origin=Borough%20Market&destination=Covent%20Garden%20London&waypoints=Southwark%20Cathedral%7CMillennium%20Bridge%7CSt%20Paul%27s%20Cathedral&travelmode=walking"
    ],
    [
      "Sir John Soane’s Museum",
      "Hidden gem",
      "Wednesday afternoon",
      "Strange, intimate, architectural, and exactly the sort of atmospheric London stop that beats a generic museum slog.",
      "https://www.soane.org/your-visit"
    ],
    [
      "Ye Olde Mitre",
      "Pub",
      "Wednesday late afternoon or any Holborn gap",
      "A historic alleyway pub that feels like a London secret even when it’s famous.",
    ...
    [
      ...
      "Candlelit, theatrical, and immersive. Better as a deliberate booking than a squeeze-in.",
