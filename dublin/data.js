window.DUBLIN_DATA = {
  ...
  pubs: [
    ...
    ['long-hall', 2, 'The Long Hall', 'Best cinematic central pub', 'Add', 'South Great George’s Street', 'First-pint material near Marlin.', 'https://www.google.com/maps/search/?api=1&query=The%20Long%20Hall%20Dublin'],
    ...
    ['palace-bar', 4, 'The Palace Bar', 'Temple Bar-edge literary pub', 'Add', 'Fleet Street', 'The acceptable historic edge-of-Temple-Bar stop.', 'https://www.google.com/maps/search/?api=1&query=The%20Palace%20Bar%20Dublin'],
    ...
    ['grogans', 6, 'Grogan’s', 'Pints / toasties / people-watching', 'Add', 'South William Street', 'Classic, busy, useful central stop.', 'https://www.google.com/maps/search/?api=1&query=Grogans%20Pub%20Dublin'],
    ['mulligans', 7, 'Mulligan’s', 'Historic pint', 'Maybe', 'Poolbeg Street', 'Classic old Dublin pub, slightly less convenient than the central core.', 'https://www.google.com/maps/search/?api=1&query=Mulligan%27s%20Poolbeg%20Street%20Dublin'],
    ...
    ['walshs', 10, 'Walsh’s', 'Stoneybatter Guinness contender', 'Maybe', 'Stoneybatter', 'Good Smithfield / Stoneybatter continuation after Cobblestone.', 'https://www.google.com/maps/search/?api=1&query=Walsh%27s%20Stoneybatter%20Dublin'],
    ['bonobo', 11, 'Bonobo', 'Stoneybatter group bar', 'Maybe', 'Stoneybatter', 'Useful modern group bar if the night keeps moving north-west.', 'https://www.bonobo.ie/'],
    ['frank-ryans', 12, 'Frank Ryan’s', 'Dark local-feeling Smithfield pub', 'Maybe', 'Smithfield / Queen Street', 'Memorable, low-polish pub option on the Smithfield route.', 'https://www.google.com/maps/search/?api=1&query=Frank%20Ryan%27s%20Bar%20Dublin'],
    ...
    ['anseo', 17, 'Anseo', 'Camden route pub', 'Maybe', 'Camden Street', 'Good low-friction Camden / Portobello stop after dinner.', 'https://www.google.com/maps/search/?api=1&query=Anseo%20Dublin'],
    ['devitts', 18, 'Devitt’s', 'Camden trad / pub fallback', 'Maybe', 'Camden Street', 'Easy Camden pub option if staying near Mister S or Delahunt.', 'https://devitts.ie/'],
    ['peruke', 19, 'Peruke & Periwig', 'Pre-dinner cocktail option', 'Maybe', 'Dawson Street', 'Central cocktail stop if the group wants a polished pre-dinner drink.', 'https://www.peruke.ie/'],
    ['sidecar', 20, 'Sidecar', 'Hotel cocktail bar', 'Maybe', 'Merrion Square', 'Elegant cocktail fallback near the Georgian walk.', 'https://www.theshelbourne.com/dine-drink/the-sidecar'],
    ['bar-1661', 21, 'Bar 1661', 'Irish cocktail bar', 'Maybe', 'North City / Capel Street', 'Excellent poitín-forward cocktail option if the route points north.', 'https://bar1661.ie/']
  ],
  activities: [
